  ...
  function s(o, u) {
    ...
    if (module.hot) {
      (function () {
        ...
        module.hot.accept();
        if (!module.hot.data) {
          hotAPI.createRecord("data-v-2dbfcc93", __vue__options__);
        } else {
          hotAPI.reload("data-v-2dbfcc93", __vue__options__);
        }
      })();
    }
  }, { "./hello.vue": 7, "vue": 3, "vueify/node_modules/vue-hot-reload-api": 5 }], 7: [function (require, module, exports) {
    var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("#hello[data-v-6546d570] {\n\tbackground-color: #050;\n\tcolor:#fff;\n\tmargin-top: 20px;\n\tpadding:30px;\n}");(function () {
      'use strict';
    ...
    __vue__options__.staticRenderFns = [];
    __vue__options__._scopeId = "data-v-6546d570";
    if (module.hot) {
      (function () {
        var hotAPI = require("vueify/node_modules/vue-hot-reload-api");
        hotAPI.install(require("vue"), true);
